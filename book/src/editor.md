...
path elements (`file-name`, `file-absolute-path`, `file-base-name`) so that the
full width is available for suggestions. The path reappears as soon as you leave
insert mode or the completion popup closes.
