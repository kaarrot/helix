...
impl DiffSpacerDecoration {
    fn new(diff_handle: &helix_vcs::DiffHandle, theme: &Theme) -> Self {
            ...
            match bg_style.bg {
                Some(Color::Rgb(br, bg, bb)) => {
                    ...
                    let (r, g, b) = if lum < 128.0 {
                        ((br as u16 + 15).min(255) as u8, (bg as u16 + 15).min(255) as u8, (bb as u16 + 15).min(255) as u8)
                    } else {
                        (br.saturating_sub(15), bg.saturating_sub(15), bb.saturating_sub(15))
                    };
        ...
        Self { spacer_rows: padding.into_iter().collect(), style }
    }
}
