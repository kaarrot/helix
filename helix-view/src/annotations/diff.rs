...
impl LineAnnotation for DiffAlignment {
    fn reset_pos(&mut self, _char_idx: usize) -> usize {
        ...
        for i in 0..diff.len() {
            ...
            let emit_after_doc_line = start.saturating_sub(1);
            *padding.entry(emit_after_doc_line).or_insert(0) += deficit;
        }
    ...
    fn insert_virtual_lines(
        ...
        // Prevent re-emitting padding for the same doc line when the formatter
        // traverses virtual rows produced by previous insertions.
